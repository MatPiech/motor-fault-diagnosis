...
class ThermoDataModule(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        valid_images_list = [list((self._data_root / dir_name / self._dataset_folder).glob('*.png')) for dir_name in valid_split]
        valid_images_list = list(itertools.chain(*valid_images_list))

        test_images_list = [list((self._data_root / dir_name / self._dataset_folder).glob('*.png')) for dir_name in test_split]
